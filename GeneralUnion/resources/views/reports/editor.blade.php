...
<ul id="reports_tabs" class="nav nav-tabs" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link"  href="#edit_report" role="tab" data-toggle="tab">Report</a>
    </li>
</ul>
<div class="container-fluid">
    <div class="tab-content">
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-6">
                        ...
                        <!-- /ko -->    
                        <input id="hidden_edit_employers" type="hidden" data-bind="value: employers"/>
                    </div>
                    <div class="form-group col-6">
        ...
        <div class="tab-pane" id="edit_report">
            <div class="row">
