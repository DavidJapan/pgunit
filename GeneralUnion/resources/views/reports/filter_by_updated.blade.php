    ...
    <div class="modal-dialog" >
        <div class="modal-content" >
            ...
            <div class="modal-footer">
                ...
                <a data-bind="click: exportExcelByUpdated" class="btn btn-primary" href="href" target="_blank">
                    <i class="fa fa-columns fa-sm" ></i> Columns
                </a>
                <a data-bind="click: exportExcelByUpdatedSingleColumn" class="btn btn-primary" href="href" target="_blank">
